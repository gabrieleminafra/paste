    ...
    <div className="min-h-screen flex items-start justify-center pt-12 px-4">
      <div className="w-full max-w-[800px] flex flex-col gap-4">
        <textarea
          ...
          className="w-full min-h-[60vh] p-4 font-mono text-[#1A1A1A] bg-white border border-border rounded-md resize-y focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 placeholder:text-muted"
        />
